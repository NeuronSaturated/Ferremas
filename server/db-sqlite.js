...
export const createTransferOrder = ({ userId, total, delivery, branch, items }) => {
  ...
  // Aqui la transferencia queda pendiente de revision manual, pero ya reserva
  // stock para no vender las mismas unidades a otro cliente.
...
export const createWebpayOrderDraft = ({
  ...
  // Aqui Webpay parte como orden pendiente: aun no se descuenta stock porque el
  // usuario puede abandonar o Transbank puede rechazar el pago.
...
export const markWebpayOrderAuthorized = ({
  ...
  // En esta parte solo se descuentan unidades reales cuando Webpay confirma.
